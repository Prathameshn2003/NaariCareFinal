...
export const DashboardSidebar = ({ onClose }: DashboardSidebarProps) => {
  ...
  return (
    <aside className="h-screen w-64 bg-sidebar-background border-r border-sidebar-border flex flex-col">
        ...
        <nav className="space-y-1 mb-6">
          {userNavItems.map((item) => (
            ...
            >
              ...
              {isActive(item.path) && <ChevronRight className="w-4 h-4 text-accent" />}
            </NavLink>
          ))}
        </nav>
